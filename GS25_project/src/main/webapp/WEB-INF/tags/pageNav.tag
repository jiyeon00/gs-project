		...
		<ul class="pagination">
		     <li data-page=1>
		      <c:if test="${pageObject.page > 1 }">
		           <a href="${listURI }?page=1&perPageNum=${pageObject.perPageNum}${query}"
		             title="click to move first page!" ${tooltip} style="text-decoration:none">
		              <i class="glyphicon" style="color: ${noLinkColor};" > << &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  </i>
		           </a>
		        </c:if>
		      <c:if test="${pageObject.page == 1 }">
		           <a href="" onclick="return false"
		            ${noMove }  ${tooltip } style="text-decoration:none " >
		           <i class="glyphicon" style="color: ${noLinkColor};"> << &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </i>
		           </a>
		        </c:if>
		   </li>
		   ...
		   <li data-page=${pageObject.startPage -1 }>
		      ...
		      <c:if test="${pageObject.startPage == 1 }">
		           <a href="" onclick="return false"
		            ${noMove } ${tooltip }>
		              <i class="glyphicon " style="text-decoration:none" > </i>
		           </a>
		        </c:if>
		     </li>
		     ...
		     <li ${(pageObject.page == cnt)?"class=\"active\"":"" } 
		      data-page=${cnt }>
		         ...
		         <c:if test="${pageObject.page == cnt }">
		           <a href="" onclick="return false"
		            ${noMove } ${tooltip } style="text-decoration:none">${cnt} &nbsp;&nbsp;&nbsp;&nbsp;</a>
		         </c:if>
		         <!-- 페이지와 cnt가 같지 않으면 링크가 있음 -->
		         <c:if test="${pageObject.page != cnt }">
		           <a href="${listURI }?page=${cnt }&perPageNum=${pageObject.perPageNum}${query}"
		            title="click to move ${cnt } page" ${tooltip } style="text-decoration:none">${cnt} &nbsp;&nbsp;&nbsp;&nbsp; </a>
		        </c:if>
		     </li>
		   </c:forEach>
		   ...
		   <c:if test="${pageObject.page < pageObject.totalPage }">
		        <li data-page=${pageObject.totalPage }>
		           <a href="${listURI }?page=${pageObject.totalPage }&perPageNum=${pageObject.perPageNum}${query}"
		             title="click to move last page!" ${tooltip } style="text-decoration:none">
		             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		              <i class="glyphicon" style="color: ${noLinkColor};"> >> </i>
		           </a>
		        </li>
