            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
              ...
              <div class="offcanvas-body">
                <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                  <li class="nav-item">
                    <a class="nav-a nav-link active" aria-current="page" href="hoem_before.do">Home</a>
                  </li>
                  <li class="nav-item">
    ...
    <section>
        <div class='container'>
            <div class='row row-1'>
                ...
                <div class='col-md-10'>
                    ...
                    <br><br><br>
                    <h4 class='section-h2 text-center'>입력하신 정보와 일치하는 아이디입니다.</h4>
                    <br/>
                    <h5 class='section-h2 text-center'>ID: ${memberfindid} </h5>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-4 col-sm-4 col-xs-4">
                ...
                <button type="button" class="btn button1" onclick="location.href='findpw.do'">비밀번호 찾기</button>
