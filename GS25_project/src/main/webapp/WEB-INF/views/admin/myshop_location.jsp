                ...
                <div class="section-1 col-md-2 col-sm-3">
                    <nav class='navbar-fixed-top'>
                        ...
                        <ul class="nav flex-column mb-2">
                            <li class="nav-item">
                                <a class="nav-link nav-a  nav-c" href="myshop_location.do">
                                &nbsp&nbsp위치
                                </a>
                            </li>
                            <li class="nav-item">
                ...
                <div class='col-md-10 col-sm-9'>
                    <div style="height: 900px; overflow: auto"> 
                        ...
                        <div id="map-container-google-1" class="z-depth-1-half map-container" style="height: 500px">
                            ...
                            <iframe src="https://maps.google.com/maps?q=37.315388798956455, 126.86507168207997&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" style="border:0" allowfullscreen>
                            </iframe>
                        </div>
