   ...
   <section>
      ...
      <div class="container">
      	...
      	<div class="col-md-10 divbox">
	      	...
	      	<br>
	      	<button type="button" class="btn loginBtn1" onclick="location.href='update.do?no=${vo.no } &inc=0'">EDIT</button>
	      	<button type="button" class="btn loginBtn1"><a href="#" class="btn-xs btn-defualt" id="deleteBtn" style="color:black; text-decoration: none;">DELETE</a></button>
	      	<button type="button" class="btn loginBtn1" onclick="location.href='list.do'">LIST</button>
      	</div>
   </div>
      <!-- 삭제를 위한 form tag -->
      <form action="delete.do" method="post" id="deleteForm">
         <input type="hidden" name="no" value="${vo.no }" /> <input
            type="hidden" name="pw" id="deletePw" />
      </form>
