...
<body>
   ...
   <header>
      <nav class="navbar navbar-light bg-light fixed-top">
         <div class="container">
            <a class="navbar-brand" href="http://localhost:8181/main/myapp/home_after.do"><svg
                  ...
                  <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                     <li class="nav-item">
                        <div id='user'>
                           ...
                           <p class='nav-a'> 경영주님&nbsp 안녕하세요!</p>
                           ...
                           </a> <a class='nav-a user-font nav-link' href="http://localhost:8181/main/myapp/home_before.do">
                              &nbsp&nbsp&nbsp <svg xmlns="http://www.w3.org/2000/svg"
                                 width="16" height="16" fill="currentColor"
                     ...
                     <li class="nav-item"><br> <br> <a
                        ...
                        href="http://localhost:8181/main/myapp/home_after.do"> <svg
                     ...
                     <li class="nav-item"><a class="nav-a nav-link"
                        href="http://localhost:8181/main/myapp/myshop.do"> <svg xmlns="http://www.w3.org/2000/svg"
                     ...
                     <li class="nav-item"><a class="nav-a nav-link"
                        href="http://localhost:8181/main/myapp/service.do"> <svg xmlns="http://www.w3.org/2000/svg"
                              width="24" height="24" viewBox="0 0 24 24" fill="none"
                              stroke="currentColor" stroke-width="2" stroke-linecap="round"
                     ...
                     <li class="nav-item"><a class="nav-a nav-link"
                        href="http://localhost:8181/main/myapp/introduce.do"> <svg
                              xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                              viewBox="0 0 24 24" fill="none" stroke="currentColor"
                              stroke-width="2" stroke-linecap="round"
                     ...
                     <li class="nav-item"><a class="nav-a nav-link active"
                        href="http://localhost:8181/main/board/notice_after.do"> <svg
                              xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                              viewBox="0 0 24 24" fill="none" stroke="currentColor"
                              stroke-width="2" stroke-linecap="round"
...
<section>
      ...
      <div class="container">
      	...
      	<div class="col-md-10 divbox">
	      	...
	      	<br>
	      	<button type="button" class="btn loginBtn1" onclick="location.href='notice_after.do'">LIST</button>
      	</div>
   </div>
