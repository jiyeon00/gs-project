                  ...
                  <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                     <li class="nav-item">
                        <div id='user'>
                           ...
                           <a class='nav-a user-font nav-link' href="/main/admin/mypage.html">
...
<section>
      ...
      <div class="container">
      	<div class="col-md-1"></div>
	         ...
	         <br> <br>
	            <a class='section-a1'>Notice Update</a>
	         </h2>
	         <br> <br> <br>
			      ...
			      <table class="table">
	                   ...
	                   <tbody>
	                       <tr class='table-tr'>
	                           ...
	                           <td class='col-8'><br/>
	                           <input name="no" value="${vo.no }" readonly="readonly"
                     			class="form-conrtol" />
	               	  <br/></td>
	                       </tr>
							<tr class='table-tr'>
	                       ...
	                       <tr class='table-tr'>
	                           ...
	                           <td><br/>
	                           	<input name="writer" value="${vo.writer }"
                			     class="form-conrtol" />
	                           <br/></td>
	                       </tr>
	                   </tbody>
		      		...
		      		<textarea rows="15" class="form-control" name="content">${vo.content }</textarea>
	               </div>
		      	<br/><br/>
		      	<button class="btn loginBtn1 loginBtn2">수정</button>
		      	<button type="reset" class="btn loginBtn1">다시 입력</button>
