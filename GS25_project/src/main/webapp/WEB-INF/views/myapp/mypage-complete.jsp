...
<body>
  ...
  <header>
    <nav class="navbar navbar-light bg-light fixed-top">
      <div class="container">
        <a class="navbar-brand" href="main-after.html">
  ...
  <section>
    <div class="container">
     ...
     <div class="col-sm-12 pt-3">
         ...
         <h6 class="title2">내 정보 수정, 회원 탈퇴 페이지 입니다.</h6>
         <p>&nbsp</p>
                 ...
                 <table class="table table-hover table-bordered box">
                     <tr class="none">
                               <th class="active" id="now_page"><a>회원 정보 수정</a></th>
                                <th class="page"><a onclick="location.href='delete.do'">회원 탈퇴하기</a></th> 
                     </tr>
                 </table>
             </div>
             <div class="card-body">
                 <div class="table-responsive">
                     <p>&nbsp</p>
                     <p>&nbsp</p>
 					<h2 class="text-center"><b>회원 정보가 수정되었습니다.</b></h2>
                    <br/><br/><br/><br/><br/><br/>
	                    <button type="button submit" class="btn" id="loginBtn" onclick="location.href='home_after.do'">HOME</button>
      ...
      <div class="container">
          <div class="row">
              <div class="col-md-7 col-sm-7 col-xs-7">
                  <div id='inner1'>
                      <a class="footer-font" href="main_after.do" aria-label="Product">
                        Sales Helper
                      </a>
                      <br><br>
