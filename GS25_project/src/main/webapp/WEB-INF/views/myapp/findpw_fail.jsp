        ...
        <div class='container'>
            <div class='row row-1'>
                ...
                <div class='col-md-10'>
                    ...
                    <h2 class='section-h2 text-center'><a class='section-a1'>비밀번호 찾기</a></h2>
                    <br><br>
                    <div class="table-responsive">
                    	<form action="findpw.do" method="post">
	                        <table class="table">
	                            ...
	                            <tr>                           
	                                <td>
	                                    <input type="text" name="homenumber" class="form-control" id="homenumber" placeholder="사업자번호">
	                                </td>
	                            </tr>
                                <tr>
	                                <td>
                                ...
                                <tr>
                                    <td>
                                        <button type="button submit" class="btn" id="loginBtn">FIND PW</button>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
