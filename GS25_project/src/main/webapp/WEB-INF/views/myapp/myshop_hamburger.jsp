            ...
            <div class='row'>
                ...
                <div class='col-md-10 col-sm-9'>
                    ...
                    <div class="row">
                        <div class="col-md-10">
                            <h5>
                            &nbsp;&nbsp;&nbsp;8월 : 입고에 비해 판매가 낮고 폐기 금액은 높다. 결국 발주량 선정을 제대로 하지 못한 것으로 보여짐 
                            <br>&nbsp;&nbsp;  9월 : 입고와 판매모두 높은 편에 속하며 폐기금액은 가장 낮다. 결국 발주량 선정을 제대로 한 것으로 보여짐 
                            </h5>
                        </div>
                    </div>
