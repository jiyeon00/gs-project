                ...
                <div class='col-md-10 col-sm-9'>
                    <div style="height: 900px; overflow: auto"> 
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <h5>
                                &nbsp;&nbsp;&nbsp;10월 : 입고와 판매가 높지만 폐끼금액이 가장 높아 발주량 선정을 제대로 하지 못한것으로 보여짐 
                                <br>&nbsp;&nbsp;  9월 : 12월과 양상이 비슷하지만 폐기금액에서 큰 차이가 나서 발주량 선정을 제일 잘한 달로 보여짐 
                                </h5>
                            </div>
                        </div>
