            ...
            <div class='row'>
                <div class="section-1 col-md-2 col-sm-3">
                    <nav class='navbar-fixed-top'>
                        ...
                        <ul class="nav flex-column mb-2">
                            ...
                            <li class="nav-item">
                                <a class="nav-link nav-a nav-c" href="myshop_home.do">
                                &nbsp&nbsp주거 형태
                                </a>
                            </li>
                            <li class="nav-item">
                ...
                <div class='col-md-10 col-sm-9'>
                    <div style="height: 900px; overflow: auto"> 
                        <div class="row">
                            <div class="chart-container">
                                <br/>
                                <h4>일동 편의점 상권 내 주거형태</h4><br/>
                                <canvas id="chart"></canvas>
                                <script>
                                    const ctx = document.getElementById("chart").getContext('2d');
                                    const myChart = new Chart(ctx, {type: 'bar',
                                    data: {
                                        labels: ["1인가구", "1세대", "2세대", "3세대"],
                                        datasets: [{
                                            label: '주거형태',backgroundColor: 'rgba(161, 198, 247, 1)',borderColor: 'rgb(47, 128, 237)',
                                            data: [1309, 554, 1950,138],}]
                                        },
                                        options: {
                                            scales: {
                    ...
                    <div class="row">
                        <div class="col-md-10">
                            <h5>
                            &nbsp;&nbsp;&nbsp;2세대 가구가 1950세대로 가장 많음
                            <br>&nbsp;&nbsp;  1인가구도 1309세대로 많은 편임
                            </h5>
                        </div>
                    </div>
