...
//		model.addAttribute("vo", loginuser);
	...
	public String bread() {
		System.out.println("service1 - controller");
		return "myapp/bread";
	}
	
	@RequestMapping(value="bread.do", method=RequestMethod.POST)
	public String service1(@Param("number1")String number1, @Param("number2")String number2, @Param("subject") String subject , Model model) {
		System.out.println("service1 - controller");
		int number_1 = Integer.parseInt(number1);
		int number_2 = Integer.parseInt(number2);
		if(subject.equals("도시락")) {			
			result = (1.4527*number_1) + ((-0.27)*number_2) + (0.109*(number_1^2)) + ((-0.2527) * (number_1*number_2)) + ((-0.8241) * (number_2 ^ 2)) + 5.4705;
	...
	public String myshop_boxlunch(Model model) {
		String product = "도시락";
		model.addAttribute("vo", myappservice.myshop(product));
		
		return "myapp/myshop_boxlunch";
	}
	@RequestMapping(value="myshop_bread.do", method=RequestMethod.GET)
	public String myshop_bread(Model model) {
		String product = "빵";
		model.addAttribute("vo", myappservice.myshop(product));
	...
	public String myshop_dessert(Model model) {
		String product = "디저트";
		model.addAttribute("vo", myappservice.myshop(product));
	...
	public String myshop_FF_food(Model model) {
		String product = "FF간편식";
		model.addAttribute("vo", myappservice.myshop(product));
		
		return "myapp/myshop_FF-food";
	}
	@RequestMapping(value="myshop_gimbap.do", method=RequestMethod.GET)
	public String myshop_gimbap(Model model) {
		String product = "김밥";
		model.addAttribute("vo", myappservice.myshop(product));
	...
	public String myshop_hamburger(Model model) {
		String product = "햄버거";
		model.addAttribute("vo", myappservice.myshop(product));
	...
	public String myshop_milk(Model model) {
		String product = "유제품";
		model.addAttribute("vo", myappservice.myshop(product));
	...
	public String myshop_sandwich(Model model) {
		String product = "샌드위치";
		model.addAttribute("vo", myappservice.myshop(product));
	...
	public String myshop_t_gimbap(Model model) {
		String product = "삼각김밥";
		model.addAttribute("vo", myappservice.myshop(product));
