...
<script type="text/javascript">
   $(function() {
      $(".dataRow").click(function() {
         ...
         location = "memberview.do?no=" + no + "&inc=1";
      });
   });
</script>
</head>
<body>
    ...
    <header>
        <nav class="navbar navbar-light bg-light fixed-top">
          <div class="container">
            <a class="navbar-brand" href="http://localhost:8181/main/myapp/home_after.do"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-basket2-fill" viewBox="0 0 16 16">
            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
              <div class="offcanvas-header">
                <p class='text-center'>
                    <a class="nav-logo nav-link" aria-current="page" href="http://localhost:8181/main/myapp/home_after.do">
                ...
                <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                    <li class="nav-item">
                        <div id='user'>
                            ...
                            <br><br>    
                            <p class='nav-a'>${vo} 경영주님&nbsp 안녕하세요!</p>
                            <a class='nav-a user-font nav-link' href="http://localhost:8181/main/myapp/mypage.do"> 
                                &nbsp&nbsp&nbsp
                                ...
                                <br>MYPAGE </a>
                            <a class='nav-a user-font nav-link' href="http://localhost:8181/main/myapp/home_before.do"> 
                                &nbsp&nbsp&nbsp
                    ...
                    <li class="nav-item">
                        <br><br>
                        <a class="nav-a nav-link" aria-current="page" href="http://localhost:8181/main/myapp/home_after.do">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home" aria-hidden="true"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg>
                            &nbspHome</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-a nav-link" href="http://localhost:8181/main/myapp/myshop.do">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-users" aria-hidden="true"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>
                            &nbsp내 점포 분석</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-a nav-link" href="http://localhost:8181/main/myapp/service.do">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-bar-chart-2" aria-hidden="true"><line x1="18" y1="20" x2="18" y2="10"></line><line x1="12" y1="20" x2="12" y2="4"></line><line x1="6" y1="20" x2="6" y2="14"></line></svg>
                        &nbspService</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-a nav-link" href="http://localhost:8181/main/myapp/introduce.do">
                    ...
                    <li class="nav-item">
                        <a class="nav-a nav-link active" href="notice_after.do">
        ...
        <div class='container'>
            ...
            <div class='row row-1'>
                ...
                <div class='col-md-10'>
                    ...
                    <br><br><br><br>
                     <button type="button" class="btn loginBtn" onclick="location.href='search1.do'">Crawling Data</button>
                    <table class="table">
                        <thead>
                            <tr class='table-tr' >
						...
						<!-- 데이터만큼 반복처리함 -->
							...
							<tr>
				               <td colspan="5">
				                  ...
				                  &nbsp;
				                     <pageObject:pageNav pageObject="${pageObject }" 
				                        listURI="notice_after.do" />
				                  </div>
				               </td>
				            </tr>
                        </tbody>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-7 col-sm-7 col-xs-7">
					<div id='inner1'>
						<a class="footer-font" href="http://localhost:8181/main/myapp/home_after.do"
