...
.divbox{margin-left: 10%; }
	.contentbox{   border-bottom: 3px solid rgb(66, 65, 65);}
	tr td{padding-top: 5%;}
            ...
            <div class="offcanvas offcanvas-end" tabindex="-1"
               ...
               <div class="offcanvas-body">
                  <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                     <li class="nav-item">
                        <div id='user'>
                           <img src='${pageContext.request.contextPath}/resources/image/user.png'  width="200px" height="200px"
                              class="rounded-circle"> <br> <br>
                           <p class='nav-a'>관리자님&nbsp 안녕하세요!</p>
                           <a class='nav-a user-font nav-link' href="/main/admin/mypage.do">
                           ...
                           </a> <a class='nav-a user-font nav-link' href="/main/myapp/home_before.do">
                              &nbsp&nbsp&nbsp <svg xmlns="http://www.w3.org/2000/svg"
                                 width="16" height="16" fill="currentColor"
                     ...
                     <li class="nav-item"><a class="nav-a nav-link"
                        href="/main/admin/myshop.do"> <svg xmlns="http://www.w3.org/2000/svg"
                     ...
                     <li class="nav-item"><a class="nav-a nav-link"
                        href="/main/admin/service.do"> <svg xmlns="http://www.w3.org/2000/svg"
                              width="24" height="24" viewBox="0 0 24 24" fill="none"
                              stroke="currentColor" stroke-width="2" stroke-linecap="round"
...
<section>
      ...
      <div class="container">
      	<div class="col-md-1"></div>
	         ...
	         <br> <br>
	            <a class='section-a1'>Notice Write </a>
	         </h2>
	         <br> <br> <br>
      	<div class="col-md-10 divbox">
      		 <form action="write.do" method="post">
			      <table class="table">
	                   ...
	                   <tbody>
	                       <tr class='table-tr'>
	                           ...
	                           <td class='col-8'><br/>
	                           <input for="title" name="title" type="text" class="form-control" id="title"
	              				 pattern=".{4,100}" maxlength="100" required="required" 
	            			   title="4자이상 100자 이하 입력" placeholder="4자이상 100자 이하 입력">
	               				<br/></td>
	                       </tr>
	                       <tr class='table-tr'>
	                           <th scope="row" class='text-center'  for="writer"><br/>WRITER<br/>&nbsp;</th>
	                           <td><br/>
	                           	 <input name="writer" type="text"
					               class="form-control" id="writer" required="required"
					               pattern="[A-Za-z가-힣][0-9A-Za-z가-힣]{1,9}" 
					               placeholder="2자이상 10자이하 입력"
		      	...
		      	<div class="contentbox"><pre style="border: none;">
				      	<textarea name="content" class="form-control" rows="15"
			            pattern=".{4,700}" maxlength="700" required="required"
			               placeholder="4자이상 700자 이하 입력" id="content"></textarea>
	               </pre></div>
		      	<br>
		      	<button class="btn loginBtn1">등록</button>
		      	<button type="button" class="btn loginBtn1" onclick="location.href='list.do'">리스트</button>
		      	<button type="reset" class="btn loginBtn1">다시입력</button>
      		 </form>
      	</div>
   </div>
      ...
      <div class="container">
         <div class="row">
            <div class="col-md-7 col-sm-7 col-xs-7">
               <div id='inner1'>
                  <a class="footer-font" href="/main/admin/adminhome_after.do" aria-label="Product">
