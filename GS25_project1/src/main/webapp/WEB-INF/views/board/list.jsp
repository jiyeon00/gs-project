        ...
        <div class='container'>
            ...
            <div class='row row-1'>
                ...
                <div class='col-md-10'>
                    ...
                    <br><br><br><br>
                     <button type="button" class="btn loginBtn" onclick="location.href='search.do'">Crawling Data</button>
                    <table class="table">
                        <thead>
                            <tr class='table-tr' >
                    	...
                    	<button type="button" class="btn loginBtn1" onclick="location.href='write.do'">글쓰기</button>
