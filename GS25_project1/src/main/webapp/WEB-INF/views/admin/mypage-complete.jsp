      ...
      <div class="container">
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
          <div class="offcanvas-header">
            <p class='text-center'>
                <a class="nav-logo nav-link" aria-current="page" href="/main/admin/adminhome_after.do">
                    Sales Helper</a></p>
          ...
          <div class="offcanvas-body">
            <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                <li class="nav-item">
                    <div id='user'>
                        <img src='${pageContext.request.contextPath}/resources/image/user.png' height="200px" class="rounded-circle"> 
                        <br><br>    
                ...
                <li class="nav-item">
                    <br><br>
                    <a class="nav-a nav-link active" aria-current="page" href="/main/admin/adminhome_after.do">
         ...
         <p>&nbsp</p>
             ...
             <div class="table-responsive">
                 ...
                 <table class="table table-hover table-bordered box">
                     <tr class="none">
                               <th class="page"><a>회원 정보 수정</a></th>
                               <th class="page" id="now_page"><a > 회원 수정 완료</a></th> 
                     </tr>
                 </table>
             </div>
             <div class="card-body">
                 <div class="table-responsive">
                    ...
                    <br/><br/><br/><br/><br/><br/>
                       <button type="button submit" class="btn" id="loginBtn" onclick="location.href='/main/admin/adminhome_after.do'">HOME</button>
