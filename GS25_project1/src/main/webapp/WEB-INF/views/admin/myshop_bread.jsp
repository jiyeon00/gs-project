                ...
                <div class="section-1 col-md-2 col-sm-3">
                    <nav class='navbar-fixed-top'>
                        ...
                        <ul class="nav flex-column mb-2">
                            ...
                            <li class="nav-item">
                                <a class="nav-link nav-a  nav-c" href="myshop_bread.do">
                                &nbsp&nbsp빵
                                </a>
                            </li>
                            <li class="nav-item">
                ...
                <div class='col-md-10 col-sm-9'>
                    <div style="height: 900px; overflow: auto"> 
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <h5>
                                &nbsp;&nbsp;&nbsp;11월 : 입고와 판매가 가장 높지만 폐기금액은 높아 발주량 선정을 제대로 하지 못한 것으로 보여짐
                                <br>&nbsp;&nbsp;12월 : 입고에 비해 판매가 좋고 판매는 다른 달과 비교해서 중간을 향하여 나타난다 결국 발주량 선정을 제대로 한 것으로 보여짐 
                                </h5>
                            </div>
                        </div>
