                ...
                <div class="section-1 col-md-2 col-sm-3">
                    <nav class='navbar-fixed-top'>
                        ...
                        <ul class="nav flex-column mb-2">
                            <li class="nav-item">
                                <a class="nav-link nav-a" href="myshop.do">
                                &nbsp&nbsp위치
                                </a>
                            </li>
                            <li class="nav-item">
                        ...
                        <ul class="nav flex-column mb-2">
                            ...
                            <li class="nav-item">
                                <a class="nav-link nav-a nav-c" href="myshop_FF-food.do">
                                &nbsp&nbspFF간편식
                                </a>
                            </li>
                            <li class="nav-item">
                    ...
                    <div style="height: 900px; overflow: auto"> 
                        <div class="row">
                            <div class="chart-container">
                                <br/>
                                <h4>FF간편식 월별폐기량</h4><br/>
                                <canvas id="chart"></canvas>
                                <script>
                                    const ctx = document.getElementById("chart").getContext('2d');
                                    const myChart = new Chart(ctx, {type: 'bar',
                                    data: {
                                        labels: ["${vo.getOne()}","${vo.getTwo()}","${vo.getThree()}","${vo.getFour()}"],
                                        datasets: [{
                                            label: '폐기량',backgroundColor: 'rgba(161, 198, 247, 1)',borderColor: 'rgb(47, 128, 237)',
                                            data: [ ${vo.getOnediscard()}, ${vo.getTwodiscard()}, ${vo.getThreediscard()},${vo.getFourdiscard()}],
                                            }]
                                        },
                                        options: {
                                            scales: {
                                    ...
                                    <div class="table-responsive month">
                                        <table class="table table-hover table-bordered table-condensed month">
                                            ...
                                            <tr>
                                                ...
                                                <td>${vo.getOneget()}</td> 
                                                <td>${vo.getTwoget()}</td> 
                                                <td>${vo.getThreeget()}</td>
                                                <td>${vo.getFourget()}</td>
                                            </tr>
                                    
                                            <tr>
                                                <th id="title">판매량</th>
                                                <td>${vo.getOnegetprice()}</td> 
												<td>${vo.getTwogetprice()}</td> 
												<td>${vo.getThreegetprice()}</td> 
												<td>${vo.getFourgetprice()}</td> 
                                    
                                            </tr>   
                                    
                                            <tr>
                                                <th id="title">폐기량</th>
                                                <td>${vo.getOnediscard()}</td> 
                                                <td>${vo.getTwodiscard()}</td> 
                                                <td>${vo.getThreediscard()}</td> 
                                                <td>${vo.getFourdiscard()}</td> 
                                            </tr>    
                                        </table>
                                    </div>
