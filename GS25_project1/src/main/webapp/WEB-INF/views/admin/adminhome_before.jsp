...
<head>
  ...
  <style>
    ...
    .bg-main{background-image: url('image/배경색.png');}
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
          ...
          <div class="offcanvas-body">
            <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
              <li class="nav-item">
                <a class="nav-a nav-link active" aria-current="page" href="/main/myapp/home_before.do">Home</a>
              </li>
              <li class="nav-item">
                <a class="nav-a nav-link" href="/main/myapp/login.do">LOGIN</a>
              </li>
              <li class="nav-item">
                <a class="nav-a nav-link" href="/main/myapp/join_agree.do">JOIN</a>
              </li>
              <li class="nav-item">
                <a class="nav-a nav-link" href="/main/myapp/login.do">내 점포 분석</a>
              </li>
              <li class="nav-item">
                <a class="nav-a nav-link" href="/main/myapp/login.do">Service</a>
              </li>
              <li class="nav-item">
                <a class="nav-a nav-link" href="/main/myapp/introduce_before.do">서비스 소개</a>
              </li>
              <li class="nav-item">
                <a class="nav-a nav-link" href="/main/board/notice_before.do">공지사항</a>
              </li>
            </ul>
          </div>
        </div>
    ...
    <main>
        <div class="p-4 p-md-5 mb-4 text-white rounded container bg-main main-img">
          ...
          <br><br><br>
            ...
            <a href="/main/myapp/join_agree.do" class="btn btn-primary my-2">가입하기</a> &nbsp
        ...
        <div class="container marketing text-center" >
          ...
          <div class="row">
              <div class="col-lg-3 col-md-6">
                  <img src='image/service-11111.png' width="210px" height="210px" class="rounded-circle">     
                  <h3><br>서비스 소개</h3>
                  <!-- <p></p> -->
                  <br>
                  <p><a class="btn btn-secondary" href="/main/myapp/introduce-before.do">View details »</a></p>
              </div>
              <div class="col-lg-3 col-md-6">
                  <img src='image/service111.jpg' width="210px" height="210px" class="rounded-circle">   
                  <h3><br>내 점포 분석</h3>
                  <!-- <p>매출 증대나 손실비용 방지 등</p> -->
                  <br>
                  <p><a class="btn btn-secondary" href="/main/myapp/login.do">View details »</a></p>
              </div>
              <div class="col-lg-3 col-md-6">
                <img src='image/service111.jpg' width="210px" height="210px" class="rounded-circle">   
                <h3><br>Service</h3>
              ...
              <div class="col-lg-3 col-md-6">
                  <img src='resources/image/service-22222.jpg' width="210px" height="210px" class="rounded-circle">     
                  <h3><br>공지사항</h3>
                  <!-- <p>알려주는 건 어때?</p> -->
                  <br>
                  <p><a class="btn btn-secondary" href="/main/board/notice-before.do">View details »</a></p>
              </div>
          </div>
        </div><br><br><br>
    </main>
