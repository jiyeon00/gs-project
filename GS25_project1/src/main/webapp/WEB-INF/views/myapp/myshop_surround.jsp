                ...
                <div class="section-1 col-md-2 col-sm-3">
                    <nav class='navbar-fixed-top'>
                        ...
                        <ul class="nav flex-column mb-2">
                            ...
                            <li class="nav-item">
                                <a class="nav-link nav-a nav-c" href="myshop_surround.do">
                                    &nbsp&nbsp주변 시설
                                </a>
                            </li>
                        </ul>
                    ...
                    <div style="height: 900px; overflow: auto"> 
                        <div class="row">
                            <div class="chart-container">
                                <br/>
                                <h4>일동 편의점 상권 내 시설 수</h4><br/>
                                <canvas id="chart"></canvas>
                                <script>
                                    const ctx = document.getElementById("chart").getContext('2d');
                                    const myChart = new Chart(ctx, {type: 'bar',
                                    data: {
                                        labels: ["음식점", "도/소매", "카페", "병원", "유치원/어린이집", "초/중학교"],
                                        datasets: [{
                                            label: '시설명',backgroundColor: 'rgba(161, 198, 247, 1)',borderColor: 'rgb(47, 128, 237)',
                                            data: [49, 13, 6, 5, 5, 2],}]
                                        },
                                        options: {
                                            scales: {
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                ...
                                <h5>
                                &nbsp;&nbsp;&nbsp;음식점이 49곳으로 가장 많음
                                <br>&nbsp;&nbsp;마트, 편의점 등 도/소매 점포가 13곳으로 다른 주변 상권에 비해 적은 편임
                                <br>&nbsp;&nbsp;중학교 및 초등학교가 2곳으로 등하교 시간대의 10대 고객이 많아질 것으로 예상
                                </h5>
                            </div>
                        </div>
