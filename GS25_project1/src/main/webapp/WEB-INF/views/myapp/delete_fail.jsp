...
<script src="http://dmaps.daum.net/map_js_init/postcode.v2.js"></script> 
  ...
  <style>
    ...
    .footer-font{color: white; text-decoration-line: none; margin-left: 15px; font-size: 17px; }
    .footer-font:hover{color:wheat; font-size: 18px;}
      ...
      <div class="container">
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
          <div class="offcanvas-header">
            <p class='text-center'>
                <a class="nav-logo nav-link" aria-current="page" href="home_after.do">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-basket2-fill" viewBox="0 0 16 16">
                        <path d="M5.929 1.757a.5.5 0 1 0-.858-.514L2.217 6H.5a.5.5 0 0 0-.5.5v1a.5.5 0 0 0 .5.5h.623l1.844 6.456A.75.75 0 0 0 3.69 15h8.622a.75.75 0 0 0 .722-.544L14.877 8h.623a.5.5 0 0 0 .5-.5v-1a.5.5 0 0 0-.5-.5h-1.717L10.93 1.243a.5.5 0 1 0-.858.514L12.617 6H3.383L5.93 1.757zM4 10a1 1 0 0 1 2 0v2a1 1 0 1 1-2 0v-2zm3 0a1 1 0 0 1 2 0v2a1 1 0 1 1-2 0v-2zm4-1a1 1 0 0 1 1 1v2a1 1 0 1 1-2 0v-2a1 1 0 0 1 1-1z"/>
                      </svg>
                      Sales Helper</a></p>
            ...
            <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                <li class="nav-item">
                    <div id='user'>
                        ...
                        <br><br>    
                        <p class='nav-a'> ${vo.getName()} 경영주님&nbsp 안녕하세요!</p>
                        <a class='nav-a user-font nav-link' href="mypage.do"> 
                            ...
                            <br>MYPAGE </a>
                        <a class='nav-a user-font nav-link' href="home_before.do"> 
                            &nbsp&nbsp&nbsp
                ...
                <li class="nav-item">
                    <br><br>
                    <a class="nav-a nav-link active" aria-current="page" href="home_after.do">
                ...
                <li class="nav-item">
                    <a class="nav-a nav-link" href="notice_after.do">
	    ...
	    <div class="container">
	     	<div class="row">
		        <h1>&nbsp</h1>
			         <p>&nbsp</p>
			         <p>&nbsp</p>
			         <h1 class="text-center"><b>MY PAGE</b></h1>
			         <h6 class="text-center">내 정보 수정, 회원 탈퇴 페이지 입니다.</h6>
			         <p>&nbsp</p>
	                 <table class="table table-hover table-bordered box">
	                     <tr class="none">
	                         <th class="page"><a onclick="location.href='mypage.do'">회원 정보 수정</a></th>
	                         <th class="active" id="now_page"><a onclick="location.href='delete.do'">회원 탈퇴하기</a></th> 
	                     </tr>
	                 </table>
	     	</div>
	         <div class="row">
	         	<div class="col-md-4 col-sm-3 col-xm-2"></div>
	         	<div class="col-md-8 col-sm-9 col-xm-10">
                    ...
                    <form action="delete.do" method="post">
                    	...
                    	<input type="password" id="pw" name ="pw" required="required" placeholder="PW" class="form-control" />
                    	 <p class="text-col">아이디 또는 비밀번호가 잘못 입력되었습니다.</p>
                    	<br/>
                    	<button type="button submit" class="btn" id="loginBtn">탈퇴하기</button>
                    </form>
                    <p>&nbsp</p>
                    <p>&nbsp</p>
                    <p>&nbsp</p>
      ...
      <div class="container">
          <div class="row">
              <div class="col-md-7 col-sm-7 col-xs-7">
                  <div id='inner1'>
                      <a class="footer-font" href="home_after.do" aria-label="Product">
                        Sales Helper
                      </a>
                      <br><br>
