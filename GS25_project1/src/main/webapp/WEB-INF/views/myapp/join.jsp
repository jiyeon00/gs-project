...
<head>
  ...
  <script src="http://dmaps.daum.net/map_js_init/postcode.v2.js"></script> 
    ...
    .loginBtn{
      ...
      .box{ background-color: rgba(242, 242, 242, 0.953);
        height: 43px; width: 50%;}
      .labelbox{
      width : 17%;
      	float: center;
      	margin-left: 10%;
        ...
        <div class="container">
            <div class="input-form-backgroud row agree"> 
                <div class="input-form col-lg-12 col-md-12 mx-auto">
                    ...
                    <p>&nbsp</p>
                    <p>&nbsp</p>
                    <p>&nbsp</p>&nbsp&nbsp&nbsp&nbsp&nbsp
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-hover table-bordered box2 ">
                            <tr class="none">
                            ...
                            <table class="table">
                               <form action="join.do" method="post">
		                           <h6>
		                              ...
		                              <input type ="text" id ="id" name="id" placeholder="ID"  class="box"/>
		                              <button type="button" id="idCheck" class="loginBtn">아이디 확인</button>
		                              <p class="alert p-box" id="no-id-alert-danger" style="color:red">아이디를 입력해주세요.</p>
		                              <p class="alert p-box" id="id-alert-success" style="color:blue">사용 가능한 아이디 입니다.</p>
		                              <p class="alert p-box" id="id-alert-danger" style="color:red">중복된 아이디입니다.</p>
		                           </h6>
		                           <h6>
		                              <label class="labelbox" for ="pw">비밀번호</label>
		                              <input type ="password" id ="pw" name="pw" placeholder="PW"  class="box"/>
		                           </h6>
		                           
		                           <h6>
		                              <label class="labelbox" for ="pw2">비밀번호 확인</label>
		                              <input type ="password" id ="pw2" name="pw2" class="box"placeholder="PW확인"  class="box"/>
		                              <button type="button" id="pwCheck" class="loginBtn">비밀번호 확인</button>
		                             <p class="alert p-box" id="no-pw-alert-danger" style="color:red">비밀번호를 입력해주세요.</p>
		                              <p class="alert p-box" id="pw-alert-success" style="color:blue">비밀번호 일치합니다.</p>
		                              <p class="alertr p-box" id="pw-alert-danger" style="color:red">비밀번호가 일치하지 않습니다.</p>
		                           ...
		                           <h6>
		                              <label class="labelbox" for ="phone">전화번호</label>
		                              <input type ="text" id ="phone" name="phone" class="box" placeholder="PHONE" />
		                           </h6>
		                           
		                           <h6>
		                              <label class="labelbox" for ="email">이메일</label>
		                              <input type ="text" id ="email" name="email" class="box" placeholder="EMAIL" />
		                              <button type="button" id="emailCheck" class="loginBtn">이메일 확인</button>
		                              <p class="alert p-box" id="no-email-alert-danger" style="color:red">이메일을 입력해주세요.</p>
		                              <p class="alert p-box" id="email-alert-success" style="color:blue">사용가능한 이메일입니다.</p>
		                              <p class="alert p-box" id="email-alert-danger" style="color:red">이미 회원가입 된 이메일입니다.</p>
		                              
		                           </h6>
		                           
		                           <h6>
		                              <label class="labelbox" for ="home">점포명</label>
		                              <input type ="text" id ="home" name="home"  class="box" placeholder="점포명" />
		                           </h6>
		                           
		                           <h6>
		                              <label class="labelbox" for ="homenumber">사업자번호</label>
		                              <input type ="text" id ="homenumber" name="homenumber"  class="box" placeholder="사업자번호" />
		                              <button type="button" id="homenumberCheck" class="loginBtn">사업자번호 확인</button>
		                              <p class="alert p-box" id="no-homenumber-alert-danger" style="color:red">사업자번호를 입력해주세요.</p>
		                              <p class="alert  p-box" id="homenumber-alert-success" style="color:blue">사용가능한 사업자번호입니다.</p>
		                              <p class="alert p-box" id="homenumber-alert-danger" style="color:red">이미 회원가입 된 사업자번호입니다.</p>
		                           </h6>
		                           <br/><br/><br/>
		                           <button class="btn loginBtn11" type="submit" id="submit">회원가입</button>
		                        </form>
                            </table>
                             <br/><br/><br/> <br/>
                        </div>
