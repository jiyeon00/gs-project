                ...
                <div class="section-1 col-md-2 col-sm-4 col-xs-3">
                    <nav class='navbar-fixed-top'>
                        ...
                        <ul class="nav flex-column mb-2">
                            ...
                            <li class="nav-item">
                                <a class="nav-link nav-a" href="FF-food.do">
                                    &nbsp&nbspFF간편식
                                </a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link nav-a1" href="bread.do">
                                    &nbsp&nbsp도시락
                                </a>
                            </li>
                            <li class="nav-item">
...
<!--                                 <form action="service.do" method="post">
                                	 <table class="table">
			                            ...
			                            <tr>
			                                <td>
			                                    <input type="text" name="subject" class="form-control me-2" id="subject" placeholder="품목">
			                                </td>
			                            </tr>
			                             <tr>                           
			                              <td>
			                                  <input type="text" name="number1" class="form-control me-2" id="number1" placeholder="입고량">
			                              </td>
			                         	</tr>
			                            <tr>                           
			                              <td>
			                                  <input type="text" name="number2" class="form-control me-2"  id="number2" placeholder="판매량">
			                              </td>
			                         	</tr>
			                            <tr>                           
			                                <td>
			                                    <input type="text" name="number3"  class="form-control me-2"  id="number3" placeholder="폐기량">
			                                </td>
			                            </tr>
			                            <tr>
			                                <td>
			                                    <button type="button submit" class="btn btn-outline-success" id="loginBtn">오늘 실적 확인하기</button>
			                                </td>
			                            </tr>
			                            </tbody>
	                       		 </table>
                                ...
                                <form action="bread.do" method="get">
                                	 <table class="table">
			                            <tbody>
				                            <tr>
				                                <td>
				                            ...
				                            <tr>                           
				                              <td>
				                                  <input type="text" name="number1" class="form-control me-2" id="number1" placeholder="날씨">
				                              </td>
				                         	</tr>
				                            <tr>                           
				                              <td>
				                                  <input type="text" name="number2" class="form-control me-2"  id="number2" placeholder="평일/주말">
				                              </td>
				                         	</tr>
				                            <tr>
				                                <td>
				                                    <button type="submit" class="btn btn-outline-success" id="loginBtn">판매량 예측하기</button>
				                                </td>
				                            </tr>
			                           </tbody>
	                       			</table>
